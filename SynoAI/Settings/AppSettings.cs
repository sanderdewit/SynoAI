...
{
    /// <summary>
    /// Strongly-typed POCO for all application settings. Registered via IOptions&lt;AppSettings&gt;
    /// for DI use. The static <see cref="Config"/> class is kept for backward compatibility with
    /// static helpers (SnapshotManager, NotifierBase, etc.) and should be migrated to IOptions
